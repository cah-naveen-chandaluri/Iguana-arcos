...
ELSE TRIM(PROD_841_D.PO_L.ITEM_NUM) END
   ...
   from PROD_841_D.PO_L 
inner join PROD_841_D.PO_L_CE
on PROD_841_D.PO_L.ORG_CODE = PROD_841_D.PO_L_CE.ORG_CODE and PROD_841_D.PO_L.PO_NUM = PROD_841_D.PO_L_CE.PO_NUM and PROD_841_D.PO_L.LINE_SEQ = PROD_841_D.PO_L_CE.LINE_SEQ   
   inner join PROD_841_D.ITEM_LICENSE_CE on PROD_841_D.PO_L.ITEM_NUM = PROD_841_D.ITEM_LICENSE_CE.ITEM_NUM and PROD_841_D.ITEM_LICENSE_CE.LICENSE_TYPE=2
   ...
   AND (PROD_841_D.LICENSE_CE.LICENSE_NUM) != 'EXEMPT' And PROD_841_D.LICENSE_CE.LICENSE_NUM != '00002868-MWD' 
   And PROD_841_D.LICENSE_CE.LICENSE_NUM != '1000585' and PROD_841_D.LICENSE_CE.LICENSE_TYPE=2
...
function sqlQueries.beforeInsertion(elite_data,i)
      ...
      sql_ins_stg_elite_po_data =
            ...
            "'"..elite_data[i].ITEM_NUM.."',"..
            "\n   '"..elite_data[i].QTY_RECEIVED.."',"..
            "\n   '"..elite_data[i].CONFIRM_DATE.."',"..
            "\n   '"..elite_data[i]["TRIM(PROD_841_D.PO_L.VENDOR_NUM)"].."',"..
            --"\n   '"..TabEliteDataCorrect[i]["TRIM(PROD_841_D.PO_L_CE.FORM_222_NUM)"].."',"..
   
            "\n  NULLIF('"..elite_data[i]["TRIM(PROD_841_D.PO_L_CE.FORM_222_NUM)"].."', '')".. ","..--this is the change we need to make
   
            "\n   '"..elite_data[i]["TRIM(PROD_841_D.PO_L.ORG_CODE)"].."',"..
            "\n   '"..elite_data[i]["TRIM(PROD_841_D.PO_L.PO_NUM)"].."',"..
            "\n   '"..elite_data[i]["TRIM(PROD_841_D.PO_L.LINE_SEQ)"].."',"..
            "\n   '"..elite_data[i]["TRIM(PROD_841_D.ITEM_LICENSE_CE.LICENSE_TYPE)"].."',"..
            "\n   '"..elite_data[i]["TRIM(PROD_841_D.PO_L.WHSE_CODE)"].."',"..
            "\n   '"..elite_data[i].DEA_LICENSE.."',"..
            "\n   '"..elite_data[i]["TRIM(PROD_841_D.ITEM.UPC)"].."'"..
