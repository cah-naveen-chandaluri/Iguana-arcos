...
local ImpSalesOrderData = require("tpl.arcos.channels.ImportSalesData")

errorIndex = 1
Cache.init('ArcosRunSalesImportProcess')
CUtil.initChannel()

local this ={}
local DEF_REQ_LOC = '/arcos/runSalesImportProcess'
...
function this.startElitePOImport() 
   Logger.logInfo('Starting elite Sales import process')
   ImpSalesOrderData.importSalesDataFromElite()
   local successMsg ='ARCOS Sales Process is successful'
