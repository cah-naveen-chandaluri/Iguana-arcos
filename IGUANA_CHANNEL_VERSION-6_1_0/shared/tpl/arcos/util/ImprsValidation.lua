local ImprsValidation =  {}

function ImprsValidation.validateValueString(OrderValue,ColumnSize) --validation for data that we got from elite
...
function ImprsValidation.validationForOrderData(EliteData)    -- this function will helps in validating data

 
end  --end validationForOrderData() function


return ImprsValidation
